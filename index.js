...
app.get('/', (request, response) => {
    const result = `Nhớ ib Facebook La Minh Lợi để cập nhật file nha (free) Facebook: https://www.facebook.com/la.minh.loi.676949`;
...
axios.get("https://raw.githubusercontent.com/Minhloidz/lml/main/package.json").then((res) => {})
startBot()
